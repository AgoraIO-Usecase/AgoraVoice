...
interface IRteEngine {
    ...
    fun adjustAudioMixingVolume(volume: Int): Int

    /*AudioEffect*/
    fun setLocalVoiceChanger(voiceManager: Int): Int

    fun setLocalVoiceReverbPreset(preset: Int): Int

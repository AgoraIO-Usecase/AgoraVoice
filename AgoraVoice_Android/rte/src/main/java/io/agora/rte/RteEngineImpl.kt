...
//                RtcEngine.destroy()
    ...
    override fun muteLocalStream(muteAudio: Boolean, muteVideo: Boolean): Int {
        val code0 = rtcEngine.muteLocalVideoStream(muteVideo)
        val code1 = rtcEngine.muteLocalAudioStream(muteAudio)
        return if (code0 == ERR_OK && code1 == ERR_OK) ERR_OK else -1
    }
    ...
    override fun setLocalVoiceChanger(type: Int): Int {
        return rtcEngine.setLocalVoiceChanger(type)
    }
    ...
    override fun setRtcParams(param: String) {

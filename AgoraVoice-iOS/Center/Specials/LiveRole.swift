...
@property (nonatomic, assign, readonly) EduRoleType role;
@end

@interface EduUser : EduBaseUser
@property (nonatomic, strong, readonly) NSString *streamUuid;
@property (nonatomic, assign, readonly) BOOL isChatAllowed;
@property (nonatomic, strong, readonly) NSDictionary *userProperties;
*/
...
//        self.permission = permission
    ...
    init(dic: StringAnyDic) throws {
        ...
        self.info = try BasicUserInfo(dic: dic)
        self.agUId = try dic.getStringValue(of: "uid")
